// component
import ACMain2sub6sup1 from "./ACMain2sub5sup1";

const ACMain2sub5 = () => {
  return (
    <div
      className="absolute bg-orange-300 p-3 w-[21%] h-[33%]
      top-[210px] left-[75.5%] rounded-lg overflow-hidden"
    >
