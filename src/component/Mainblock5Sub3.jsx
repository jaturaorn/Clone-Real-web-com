  ...
  return (
    <div>
      ...
      <div className="flex justify-end max-sm:justify-center">
        <div class="inline-flex justify-end rounded-md shadow-sm" role="group">
          <button
            type="button"
            class="px-2 py-2 text-sm font-medium text-gray-900 bg-transparent 
